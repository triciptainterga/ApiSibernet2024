...
{
    public partial class mixradius_radDBContext : DbContext
    {
        public IConfiguration Configuration { get; }
        public mixradius_radDBContext()
        {
        }

        public mixradius_radDBContext(DbContextOptions<mixradius_radDBContext> options)
            : base(options)
        {
        }
